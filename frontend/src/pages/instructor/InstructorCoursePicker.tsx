  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-[#5C635D]">{description}</p>
      </div>
          ...
          <Card key={c.id}>
            <div className="flex items-center justify-between gap-3">
              <div className="min-w-0">
                <h3 className="font-medium text-[#1F2421] truncate">{c.title}</h3>
                <p className="text-xs text-[#5C635D] capitalize">{c.status ?? 'draft'}</p>
              </div>
